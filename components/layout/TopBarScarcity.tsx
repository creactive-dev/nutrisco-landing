...
export function TopBarScarcity() {
  ...
  // Copy estático — sin contador de cupos en vivo (decisión comercial: el
  // número real de disponibles no genera FOMO, mantenemos solo el framing).
  const messageDesktop = TOP_BAR_SCARCITY.message
  const messageMobile = TOP_BAR_SCARCITY.messageMobile
