...
look A: polerón burdeo y chaleco crema). Vienen en HDR (HLG): los cuadros se sacaron después de pasarlos a
SDR con `avconvert` (preset H.264 1080p, que convierte a BT.709) y `ffmpeg`.
